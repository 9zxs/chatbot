...
if st.session_state.messages:
    ...
    for idx, chat in enumerate(st.session_state.messages):
        ...
        # Feedback buttons under each bot response
        chat_html += f"""
        <div class="feedback-container">
            <form action="" method="post" style="display:inline;">
                <button class="feedback-btn positive" name="yes_{idx}" type="submit">👍 Helpful</button>
            </form>
            <form action="" method="post" style="display:inline;">
                <button class="feedback-btn negative" name="no_{idx}" type="submit">👎 Not Helpful</button>
            </form>
        </div>
        """
    ...
    # Render the chat with scrollbar preserved
