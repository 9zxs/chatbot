...
with st.sidebar:
    ...
    st.markdown("This AI assistant helps with university-related queries using machine learning to understand your questions and provide relevant responses.")    except FileNotFoundError:
        st.error("Intents file not found. Please ensure 'data/intents.json' exists.")
        return {}
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("### ℹ️ About")
    st.markdown("This AI assistant helps with university-related queries using machine learning to understand your questions and provide relevant responses.")        background-color: #DCF8C6;
        padding: 10px;
        border-radius: 15px;
        margin: 5px 0;
        text-align: right;
